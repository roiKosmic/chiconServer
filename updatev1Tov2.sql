...
INSERT INTO `chicon_db`.`led_service_list` (`id`, `id_led_service`, `id_service`, `led_type`, `common_name`, `description`) VALUES (NULL, '1', '7', '4', 'RGB Iftt', 'Light when a ifttt event occurs');
...
INSERT INTO `chicon_db`.`led_service_list` (`id`, `id_led_service`, `id_service`, `led_type`, `common_name`, `description`) VALUES (NULL, '1', '8', '1', 'Binary Iftt', 'Light on/off when a ifttt event occurs');
...
INSERT INTO `chicon_db`.`led_service_list` (`id`, `id_led_service`, `id_service`, `led_type`, `common_name`, `description`) VALUES (NULL, '1', '9', '8', 'Blinking Iftt', 'Blink when a ifttt event occurs');
...
INSERT INTO `chicon_db`.`led_service_list` (`id`, `id_led_service`, `id_service`, `led_type`, `common_name`, `description`) VALUES (NULL, '1', '10', '2', 'Tricolor Iftt', 'Tricolor light when IFTTT event occurs');
...
INSERT INTO `chicon_db`.`led_service_list` (`id`, `id_led_service`, `id_service`, `led_type`, `common_name`, `description`) VALUES (NULL, '1', '11', '2', 'Tricolor Open Health', 'Tricolor light indicating selected disease intensity');
